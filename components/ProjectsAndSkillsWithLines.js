    ...
    <main className="relative bg-background text-foreground min-h-screen">
      ...
      >
        <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-4">
          {/* Company Box */}
          <div className="border-4 border-primary bg-secondary rounded-lg p-6 shadow-lg relative group">
          ...
          {/* Projects Container */}
          <div className="border-4 border-primary bg-secondary rounded-lg p-6 shadow-lg">
