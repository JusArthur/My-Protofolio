    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.div
            className="border-4 border-primary bg-secondary rounded-lg p-6 shadow-lg col-span-1 lg:col-span-2 mt-4"
            variants={fadeInVariant}
            initial="hidden"
            animate={isInView ? "visible" : "hidden"}
          ...
          >
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h2 className="text-primary text-3xl font-bold">Open Source Contribution</h2>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              {/* Spotube Project */}
              <motion.div
                className="border-4 border-secondary bg-background rounded-lg p-4 shadow relative group project-spotube"
              ...
              <motion.div
                className="border-4 border-secondary bg-background rounded-lg p-4 shadow relative group project-reconciliation"
